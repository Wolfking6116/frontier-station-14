...
round-end-system-shuttle-auto-called-announcement = An automatic crew shift change has been started. ETA: {$time} {$units}. Recall the shuttle to extend the shift.
